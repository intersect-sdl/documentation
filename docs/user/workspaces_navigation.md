...
2. A dropdown shows available workspaces and recent ones.
3. Select a workspace to switch contexts.
4. Optional: Use the search bar to find specific workspace names.
...
- `Ctrl+K` (or `Cmd+K`) to open the quick switcher
